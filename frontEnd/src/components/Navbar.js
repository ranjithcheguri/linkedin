...
class Navbar extends Component {
    ...
    searchUser=()=>{
        ...
        if(this.state.searchString.length>0){
            localStorage.setItem('searchUser',this.state.searchString);
                ...
                <nav className="navbar navbar-expand-lg navbar-light">
                    <div className="container">
                        ...
                        <form className="form-inline my-2 my-lg-0">
                            ...
                            <button className="btn btn-outline-light my-2 my-sm-0 iconColour" onClick={this.searchUser} type="submit">Search</button>
                        </form>
                        <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                            ...
                            <div class="borderLeft mr-auto mt-2 mt-lg-0">
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <a className="nav-link" href="#"><i class="fal fa-building fa-lg iconColour"></i><br />
                                            <span class="nav-icon-text">Work</span></a>
                                    </li>
                                    <li className="nav-item ">
